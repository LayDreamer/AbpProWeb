  ...
  <div>
    <PageWrapper dense contentFullHeight contentClass="flex">
      <div class="bg-white m-4  mr-0 overflow-hidden">
        <BasicTree toolbar search :treeData="treeData" :beforeRightClick="getRightMenuList" @select="handleSelect">
          <template #headerTitle>
            ...
            <a-button type="primary" style="margin-left: 20px" size="small"
              v-auth="'AbpIdentity.OrganizationUnitManagement.Create'" @click="createRootOrganizationUnit">
        ...
        <a-tabs v-model:activeKey="activeKey" @change="activeKeyChange">
            ...
            <BasicTable @register="registerUserTable" size="small">
              <template #toolbar>
                <a-button preIcon="ant-design:plus-circle-outlined" type="primary"
                  v-auth="'AbpIdentity.OrganizationUnitManagement.Update'" @click="openAddUserToOrganizationUnitModal">
                  {{ t("common.createText") }}
                </a-button>
              </template>>
          ...
          <a-tab-pane key="2" :tab="t('routes.admin.role')">
            <BasicTable @register="registerRoleTable" size="small">
              <template #toolbar>
                <a-button preIcon="ant-design:plus-circle-outlined" type="primary"
                  v-auth="'AbpIdentity.OrganizationUnitManagement.Update'" @click="openAddRoleToOrganizationUnitModal">
                  {{ t("common.createText") }}
                </a-button>
