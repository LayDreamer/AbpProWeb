    ...
    <div class="px-2 py-2 h-full">
      <div class="flex flex-col">
        <div class="flex flex-row">
          ...
          <div class="flex-1 ml-2 flex flex-col relative">
...
import { getDetailData, getProjectInfo, MaterialManageHomeDto } from '../../index';
import { Loading } from '/@/components/Loading';
import { MaterialManageFullDto } from '/@/services/ServiceProxies';
  export default defineComponent({
    props: {
      initData: {
        type: Object as PropType<MaterialManageHomeDto>,
        required: true,
      },
    },
    components: { ACard: Card, Loading, AImage: Image },
    watch: {
      async initData(v) {
        await this.initDetail(v.id);
      },
    },
    setup(_, { emit }) {
      ...
      function detailPickerClick() {
        emit('detailPicker', true);
      }
      return {
        data,
        supplierCollapsed,
