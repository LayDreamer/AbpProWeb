...
export class AccountServiceProxy extends ServiceProxyBase {
     ...
     * @return Success
     */
    domainLogin(body: LoginInput | undefined , cancelToken?: CancelToken | undefined): Promise<LoginOutput> {
        let url_ = this.baseUrl + "/api/app/account/domain-login";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processDomainLogin(_response));
        });
    }

    protected processDomainLogin(response: AxiosResponse): Promise<LoginOutput> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
...
export class FamilyLibsServiceProxy extends ServiceProxyBase {
    private instance: AxiosInstance;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    protected processCreat(response: AxiosResponse): Promise<FamilyLibDto> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200  = _responseText;
            result200 = FamilyLibDto.fromJS(resultData200);
    ...
    delete(id: string | undefined , cancelToken?: CancelToken | undefined): Promise<void> {
        let url_ = this.baseUrl + "/FamilyLibs/Delete?";
        if (id === null)
     ...
     * @return Success
     */
    getById(id: string | undefined , cancelToken?: CancelToken | undefined): Promise<FamilyLibDto> {
        let url_ = this.baseUrl + "/FamilyLibs/GetById?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
    ...
    protected processGetById(response: AxiosResponse): Promise<FamilyLibDto> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return Success
     */
    getWithParamer(body: PagedAndSortedResultRequestDto | undefined , cancelToken?: CancelToken | undefined): Promise<FamilyLibDtoPagedResultDto> {
        let url_ = this.baseUrl + "/FamilyLibs/GetWithParamer";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processGetWithParamer(_response));
        });
    }

    protected processGetWithParamer(response: AxiosResponse): Promise<FamilyLibDtoPagedResultDto> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200  = _responseText;
            result200 = FamilyLibDtoPagedResultDto.fromJS(resultData200);
            return Promise.resolve<FamilyLibDtoPagedResultDto>(result200);
        ...
        return Promise.resolve<FamilyLibDtoPagedResultDto>(null as any);
    }
    ...
    protected processUpdate(response: AxiosResponse): Promise<FamilyLibDto> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return Success
     */
    getListByTreeId(body: OrderNotificationSearchDto | undefined , cancelToken?: CancelToken | undefined): Promise<FamilyLibDtoPagedResultDto> {
        let url_ = this.baseUrl + "/FamilyLibs/GetListByTreeId";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetListByTreeId(response: AxiosResponse): Promise<FamilyLibDtoPagedResultDto> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return Success
     */
    getFamilyModule(guid: string | undefined , cancelToken?: CancelToken | undefined): Promise<FamilyLibDto[]> {
        let url_ = this.baseUrl + "/FamilyLibs/GetFamilyModule?";
        if (guid === null)
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processGetFamilyModule(_response));
        });
    }

    protected processGetFamilyModule(response: AxiosResponse): Promise<FamilyLibDto[]> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
    ...
    uploadFamilyLibImage(id: string | undefined, file: FileParameter | undefined , cancelToken?: CancelToken | undefined): Promise<ImageResponseDto> {
        let url_ = this.baseUrl + "/FamilyLibs/UploadFamilyLibImage";
        url_ = url_.replace(/[?&]$/, "");
...
export class FamilyTreeServiceProxy extends ServiceProxyBase {
    ...
    protected processCreat(response: AxiosResponse): Promise<FamilyTreeDto> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200  = _responseText;
            result200 = FamilyTreeDto.fromJS(resultData200);
     ...
     */
    delete(id: string | undefined , cancelToken?: CancelToken | undefined): Promise<void> {
        let url_ = this.baseUrl + "/FamilyTree/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
     ...
     * @return Success
     */
    getById(id: string | undefined , cancelToken?: CancelToken | undefined): Promise<FamilyTreeDto> {
        let url_ = this.baseUrl + "/FamilyTree/GetById?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
    ...
    protected processGetById(response: AxiosResponse): Promise<FamilyTreeDto> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return Success
     */
    getWithParamer(body: PagedAndSortedResultRequestDto | undefined , cancelToken?: CancelToken | undefined): Promise<FamilyTreeDtoPagedResultDto> {
        let url_ = this.baseUrl + "/FamilyTree/GetWithParamer";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetWithParamer(response: AxiosResponse): Promise<FamilyTreeDtoPagedResultDto> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
    ...
    protected processUpdate(response: AxiosResponse): Promise<FamilyTreeDto> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
...
export class ProductInventoryProductServiceProxy extends ServiceProxyBase {
     ...
     * @return Success
     */
    insert(id: string | undefined, body: ProductInventoryProductCreateDto | undefined , cancelToken?: CancelToken | undefined): Promise<ProductInventoryProductDto> {
        let url_ = this.baseUrl + "/ProductInventoryProduct/Insert?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processInsert(_response));
        });
    }

    protected processInsert(response: AxiosResponse): Promise<ProductInventoryProductDto> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200  = _responseText;
            result200 = ProductInventoryProductDto.fromJS(resultData200);
            return Promise.resolve<ProductInventoryProductDto>(result200);
        ...
        return Promise.resolve<ProductInventoryProductDto>(null as any);
    }

    /**
     * @param system (optional) 
     * @param series (optional) 
     * @param seriesRemark (optional) 
     * @param body (optional) 
     * @return Success
     */
    importFromExcel(system: string | undefined, series: string | undefined, seriesRemark: string | undefined, body: ProductInventoryProductCreateDto[] | undefined , cancelToken?: CancelToken | undefined): Promise<ProductInventoryProductDto[]> {
        let url_ = this.baseUrl + "/ProductInventoryProduct/ImportFromExcel?";
        if (system === null)
            throw new Error("The parameter 'system' cannot be null.");
        else if (system !== undefined)
            url_ += "system=" + encodeURIComponent("" + system) + "&";
        if (series === null)
            throw new Error("The parameter 'series' cannot be null.");
        else if (series !== undefined)
            url_ += "series=" + encodeURIComponent("" + series) + "&";
        if (seriesRemark === null)
            throw new Error("The parameter 'seriesRemark' cannot be null.");
        else if (seriesRemark !== undefined)
            url_ += "seriesRemark=" + encodeURIComponent("" + seriesRemark) + "&";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processImportFromExcel(response: AxiosResponse): Promise<ProductInventoryProductDto[]> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(ProductInventoryProductDto.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
     ...
     * @return Success
     */
    addProduct(body: ProductInventoryFullDto[] | undefined , cancelToken?: CancelToken | undefined): Promise<ProductInventoryProductDto[]> {
        let url_ = this.baseUrl + "/ProductInventoryProduct/AddProduct";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processAddProduct(_response));
        });
    }

    protected processAddProduct(response: AxiosResponse): Promise<ProductInventoryProductDto[]> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return Success
     */
    copyProduct(body: string[] | undefined , cancelToken?: CancelToken | undefined): Promise<ProductInventoryProductDto[]> {
        let url_ = this.baseUrl + "/ProductInventoryProduct/CopyProduct";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processCopyProduct(_response));
        });
    }

    protected processCopyProduct(response: AxiosResponse): Promise<ProductInventoryProductDto[]> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return Success
     */
    deleteProducts(body: string[] | undefined , cancelToken?: CancelToken | undefined): Promise<string> {
        let url_ = this.baseUrl + "/ProductInventoryProduct/DeleteProducts";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processDeleteProducts(_response));
        });
    }

    protected processDeleteProducts(response: AxiosResponse): Promise<string> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return Success
     */
    deleteEdits(body: ProductInventoryFullDto[] | undefined , cancelToken?: CancelToken | undefined): Promise<string> {
        let url_ = this.baseUrl + "/ProductInventoryProduct/DeleteEdits";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processDeleteEdits(_response));
        });
    }

    protected processDeleteEdits(response: AxiosResponse): Promise<string> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return Success
     */
    updateProduct(body: ProductInventoryFullDto | undefined , cancelToken?: CancelToken | undefined): Promise<ProductInventoryProductDto> {
        let url_ = this.baseUrl + "/ProductInventoryProduct/UpdateProduct";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processUpdateProduct(_response));
        });
    }

    protected processUpdateProduct(response: AxiosResponse): Promise<ProductInventoryProductDto> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return Success
     */
    publishProducts(body: { [key: string]: ProductInventoryPublishStatus; } | undefined , cancelToken?: CancelToken | undefined): Promise<ProductInventoryProductDto[]> {
        let url_ = this.baseUrl + "/ProductInventoryProduct/PublishProducts";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processPublishProducts(_response));
        });
    }

    protected processPublishProducts(response: AxiosResponse): Promise<ProductInventoryProductDto[]> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return Success
     */
    pageProducts(body: OrderNotificationSearchDto | undefined , cancelToken?: CancelToken | undefined): Promise<ProductInventoryProductDtoPagedResultDto> {
        let url_ = this.baseUrl + "/ProductInventoryProduct/PageProducts";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processPageProducts(_response));
        });
    }

    protected processPageProducts(response: AxiosResponse): Promise<ProductInventoryProductDtoPagedResultDto> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200  = _responseText;
            result200 = ProductInventoryProductDtoPagedResultDto.fromJS(resultData200);
            return Promise.resolve<ProductInventoryProductDtoPagedResultDto>(result200);
        ...
        return Promise.resolve<ProductInventoryProductDtoPagedResultDto>(null as any);
    }
     ...
     * @return Success
     */
    getProductDetails(id: string | undefined , cancelToken?: CancelToken | undefined): Promise<ProductInventoryFullDto> {
        let url_ = this.baseUrl + "/ProductInventoryProduct/GetProductDetails?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processGetProductDetails(_response));
        });
    }

    protected processGetProductDetails(response: AxiosResponse): Promise<ProductInventoryFullDto> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200  = _responseText;
            result200 = ProductInventoryFullDto.fromJS(resultData200);
            return Promise.resolve<ProductInventoryFullDto>(result200);
        ...
        return Promise.resolve<ProductInventoryFullDto>(null as any);
    }

    /**
     * @return Success
     */
    erpGetToken(  cancelToken?: CancelToken | undefined): Promise<string> {
        let url_ = this.baseUrl + "/ProductInventoryProduct/ErpGetToken";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processErpGetToken(_response));
        });
    }

    protected processErpGetToken(response: AxiosResponse): Promise<string> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return Success
     */
    erpGetProduct(accessToken: string | undefined, postData: string | undefined , cancelToken?: CancelToken | undefined): Promise<ProductInventoryEditDto[]> {
        let url_ = this.baseUrl + "/ProductInventoryProduct/ErpGetProduct?";
        if (accessToken === null)
            throw new Error("The parameter 'accessToken' cannot be null.");
        else if (accessToken !== undefined)
            url_ += "accessToken=" + encodeURIComponent("" + accessToken) + "&";
        if (postData === null)
            throw new Error("The parameter 'postData' cannot be null.");
        else if (postData !== undefined)
            url_ += "postData=" + encodeURIComponent("" + postData) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processErpGetProduct(_response));
        });
    }

    protected processErpGetProduct(response: AxiosResponse): Promise<ProductInventoryEditDto[]> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(ProductInventoryEditDto.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
            return Promise.resolve<ProductInventoryEditDto[]>(result200);
        ...
        return Promise.resolve<ProductInventoryEditDto[]>(null as any);
    }
     ...
     * @return Success
     */
    uploadProductImage(id: string | undefined, file: FileParameter | undefined , cancelToken?: CancelToken | undefined): Promise<ImageResponseDto> {
        let url_ = this.baseUrl + "/ProductInventoryProduct/UploadProductImage";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processUploadProductImage(_response));
        });
    }

    protected processUploadProductImage(response: AxiosResponse): Promise<ImageResponseDto> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
...
export class ProductInventoryTreeServiceProxy extends ServiceProxyBase {
    private instance: AxiosInstance;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    getTree(  cancelToken?: CancelToken | undefined): Promise<ProductInventoryTreeDto[]> {
        let url_ = this.baseUrl + "/ProductInventoryTree/GetTree";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetTree(response: AxiosResponse): Promise<ProductInventoryTreeDto[]> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(ProductInventoryTreeDto.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
            return Promise.resolve<ProductInventoryTreeDto[]>(result200);
        ...
        return Promise.resolve<ProductInventoryTreeDto[]>(null as any);
    }
     ...
     * @return Success
     */
    updateRemark(id: string | undefined, remark: string | undefined , cancelToken?: CancelToken | undefined): Promise<ProductInventoryTreeDto> {
        let url_ = this.baseUrl + "/ProductInventoryTree/UpdateRemark?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
    ...
    protected processUpdateRemark(response: AxiosResponse): Promise<ProductInventoryTreeDto> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200  = _responseText;
            result200 = ProductInventoryTreeDto.fromJS(resultData200);
            return Promise.resolve<ProductInventoryTreeDto>(result200);
...
export class ProductRetrievalServiceProxy extends ServiceProxyBase {
    private instance: AxiosInstance;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    page(body: ProductIndexSearchDto | undefined , cancelToken?: CancelToken | undefined): Promise<ProductRetrievalDtoPagedResultDto> {
        let url_ = this.baseUrl + "/ProductRetrieval/Page";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processPage(response: AxiosResponse): Promise<ProductRetrievalDtoPagedResultDto> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200  = _responseText;
            result200 = ProductRetrievalDtoPagedResultDto.fromJS(resultData200);
            return Promise.resolve<ProductRetrievalDtoPagedResultDto>(result200);
        ...
        return Promise.resolve<ProductRetrievalDtoPagedResultDto>(null as any);
    }
    ...
    findByInput(body: ProductRetrievalSearchDto | undefined , cancelToken?: CancelToken | undefined): Promise<ProductRetrievalResultDtoPagedResultDto> {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processFindByInput(_response));
        });
    }

    protected processFindByInput(response: AxiosResponse): Promise<ProductRetrievalResultDtoPagedResultDto> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200  = _responseText;
            result200 = ProductRetrievalResultDtoPagedResultDto.fromJS(resultData200);
            return Promise.resolve<ProductRetrievalResultDtoPagedResultDto>(result200);
    ...
    exportToExcel(body: any | undefined , cancelToken?: CancelToken | undefined): Promise<void> {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processExportToExcel(_response));
        });
    }
...
export class ProjectInfoServiceProxy extends ServiceProxyBase {
    private instance: AxiosInstance;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
...
export class StandardAndPolicyThemeServiceProxy extends ServiceProxyBase {
    private instance: AxiosInstance;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    uploadFile(file: FileParameter | undefined , cancelToken?: CancelToken | undefined): Promise<ApiResultDto> {
        let url_ = this.baseUrl + "/StandardAndPolicyLib/UploadFile";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    insert(body: StandardAndPolicyCreateAndUpdateDto | undefined , cancelToken?: CancelToken | undefined): Promise<StandardAndPolicyThemeDto[]> {
        let url_ = this.baseUrl + "/StandardAndPolicyLib/Insert";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processInsert(response: AxiosResponse): Promise<StandardAndPolicyThemeDto[]> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(StandardAndPolicyThemeDto.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
            return Promise.resolve<StandardAndPolicyThemeDto[]>(result200);
        ...
        return Promise.resolve<StandardAndPolicyThemeDto[]>(null as any);
    }
...
export class StandardAndPolicyTreeServiceProxy extends ServiceProxyBase {
     ...
     * @return Success
     */
    getTree(  cancelToken?: CancelToken | undefined): Promise<StandardAndPolicyTreeDto[]> {
        let url_ = this.baseUrl + "/StandardAndPolicyTree/GetTree";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    addChild(id: string | undefined, nodeName: string | undefined , cancelToken?: CancelToken | undefined): Promise<StandardAndPolicyTreeDto> {
        let url_ = this.baseUrl + "/StandardAndPolicyTree/AddChild?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        if (nodeName === null)
            throw new Error("The parameter 'nodeName' cannot be null.");
        else if (nodeName !== undefined)
            url_ += "nodeName=" + encodeURIComponent("" + nodeName) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processAddChild(_response));
        });
    }

    protected processAddChild(response: AxiosResponse): Promise<StandardAndPolicyTreeDto> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200  = _responseText;
            result200 = StandardAndPolicyTreeDto.fromJS(resultData200);
            return Promise.resolve<StandardAndPolicyTreeDto>(result200);
    ...
    deleteChild(id: string | undefined , cancelToken?: CancelToken | undefined): Promise<void> {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processDeleteChild(_response));
        });
    }
     ...
     * @return Success
     */
    reNameChild(id: string | undefined, nodeName: string | undefined , cancelToken?: CancelToken | undefined): Promise<StandardAndPolicyTreeDto> {
        let url_ = this.baseUrl + "/StandardAndPolicyTree/ReNameChild?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processReNameChild(_response));
        });
    }

    protected processReNameChild(response: AxiosResponse): Promise<StandardAndPolicyTreeDto> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
...
export class FamilyLibDto implements IFamilyLibDto {
    ...
    constructor(data?: IFamilyLibDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): FamilyLibDto {
        data = typeof data === 'object' ? data : {};
        let result = new FamilyLibDto();
        result.init(data);
        return result;
    }
...
export interface IFamilyLibDto {
    id: string;
    creationTime: dayjs.Dayjs;
    creatorId: string | undefined;
    lastModificationTime: dayjs.Dayjs | undefined;
...
export class FamilyLibDtoPagedResultDto implements IFamilyLibDtoPagedResultDto {
    items!: FamilyLibDto[] | undefined;
    totalCount!: number;

    constructor(data?: IFamilyLibDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            if (Array.isArray(_data["items"])) {
                ...
                for (let item of _data["items"])
                    this.items!.push(FamilyLibDto.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): FamilyLibDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new FamilyLibDtoPagedResultDto();
        result.init(data);
        return result;
    }
...
export class FamilyTreeDto implements IFamilyTreeDto {
    ...
    constructor(data?: IFamilyTreeDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): FamilyTreeDto {
        data = typeof data === 'object' ? data : {};
        let result = new FamilyTreeDto();
        result.init(data);
        return result;
    }
...
export interface IFamilyTreeDto {
    id: string;
    creationTime: dayjs.Dayjs;
    creatorId: string | undefined;
    lastModificationTime: dayjs.Dayjs | undefined;
...
export class FamilyTreeDtoPagedResultDto implements IFamilyTreeDtoPagedResultDto {
    items!: FamilyTreeDto[] | undefined;
    totalCount!: number;

    constructor(data?: IFamilyTreeDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items!.push(FamilyTreeDto.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): FamilyTreeDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new FamilyTreeDtoPagedResultDto();
        result.init(data);
        return result;
    }
...
export interface IFamilyTreeDtoPagedResultDto {
    items: FamilyTreeDto[] | undefined;
    totalCount: number;
}
...
export class MaterialInventoryDto implements IMaterialInventoryDto {
    ...
    static fromJS(data: any): MaterialInventoryDto {
        data = typeof data === 'object' ? data : {};
        let result = new MaterialInventoryDto();
        result.init(data);
        return result;
    }
...
export class OrderNotificationSearchDto implements IOrderNotificationSearchDto {
    ...
    static fromJS(data: any): OrderNotificationSearchDto {
        data = typeof data === 'object' ? data : {};
        let result = new OrderNotificationSearchDto();
        result.init(data);
        return result;
    }
...
export interface IOrderNotificationSearchDto {
    maxResultCount: number;
    skipCount: number;
    sorting: string | undefined;
    key: string | undefined;
...
export class PagedAndSortedResultRequestDto implements IPagedAndSortedResultRequestDto {
    maxResultCount!: number;
    skipCount!: number;
    sorting!: string | undefined;

    constructor(data?: IPagedAndSortedResultRequestDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): PagedAndSortedResultRequestDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedAndSortedResultRequestDto();
        result.init(data);
        return result;
    }
...
export interface IPagedAndSortedResultRequestDto {
    maxResultCount: number;
    skipCount: number;
    sorting: string | undefined;
}
...
export class ProductIndexSearchDto implements IProductIndexSearchDto {
    ...
    static fromJS(data: any): ProductIndexSearchDto {
        data = typeof data === 'object' ? data : {};
        let result = new ProductIndexSearchDto();
        result.init(data);
        return result;
    }
...
export interface IProductIndexSearchDto {
    maxResultCount: number;
    skipCount: number;
    sorting: string | undefined;
    key: string | undefined;
...
export class ProductInventoryEditDto implements IProductInventoryEditDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.productSpecification = _data["productSpecification"];
            ...
            this.limitInfos = _data["limitInfos"];
            this.inModuleMaterial = _data["inModuleMaterial"];
    ...
    static fromJS(data: any): ProductInventoryEditDto {
        data = typeof data === 'object' ? data : {};
        let result = new ProductInventoryEditDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["limitInfos"] = this.limitInfos;
        data["inModuleMaterial"] = this.inModuleMaterial;
...
export interface IProductInventoryEditDto {
    id: string;
    creationTime: dayjs.Dayjs;
    creatorId: string | undefined;
    lastModificationTime: dayjs.Dayjs | undefined;
...
export class ProductInventoryFullDto implements IProductInventoryFullDto {
    ...
    parentTag!: ProductInventroyTag;
    tag!: ProductInventroyTag;
    children!: ProductInventoryFullDto[] | undefined;
    status!: ProductInventoryModifyStatus;
    data!: ProductInventoryEditDto;

    constructor(data?: IProductInventoryFullDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.parentTag = _data["parentTag"];
            this.tag = _data["tag"];
            if (Array.isArray(_data["children"])) {
                this.children = [] as any;
                for (let item of _data["children"])
                    this.children!.push(ProductInventoryFullDto.fromJS(item));
            }
            this.status = _data["status"];
            this.data = _data["data"] ? ProductInventoryEditDto.fromJS(_data["data"]) : <any>undefined;
        }
    }

    static fromJS(data: any): ProductInventoryFullDto {
        data = typeof data === 'object' ? data : {};
        let result = new ProductInventoryFullDto();
        result.init(data);
        return result;
    }
...
export interface IProductInventoryFullDto {
    parentId: string | undefined;
    id: string | undefined;
    parentTag: ProductInventroyTag;
    tag: ProductInventroyTag;
...
export class ProductInventoryMaterialCreateDto implements IProductInventoryMaterialCreateDto {
    name!: string | undefined;
    code!: string | undefined;
    level!: string | undefined;
    length!: string | undefined;
    ...
    constructor(data?: IProductInventoryMaterialCreateDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ProductInventoryMaterialCreateDto {
        data = typeof data === 'object' ? data : {};
        let result = new ProductInventoryMaterialCreateDto();
        result.init(data);
        return result;
    }
...
export interface IProductInventoryMaterialCreateDto {
    name: string | undefined;
    code: string | undefined;
    level: string | undefined;
    length: string | undefined;
...
export class ProductInventoryMaterialDto implements IProductInventoryMaterialDto {
    id!: string;
    creationTime!: dayjs.Dayjs;
    creatorId!: string | undefined;
    lastModificationTime!: dayjs.Dayjs | undefined;
    ...
    constructor(data?: IProductInventoryMaterialDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ProductInventoryMaterialDto {
        data = typeof data === 'object' ? data : {};
        let result = new ProductInventoryMaterialDto();
        result.init(data);
        return result;
    }
...
export interface IProductInventoryMaterialDto {
    id: string;
    creationTime: dayjs.Dayjs;
    creatorId: string | undefined;
    lastModificationTime: dayjs.Dayjs | undefined;
...
export enum ProductInventoryModifyStatus {
    Normal = 1,
    Modify = 1000,
    Insert = 2000,
    Delete = 3000,
...
export class ProductInventoryModuleCreateDto implements IProductInventoryModuleCreateDto {
    level!: string | undefined;
    name!: string | undefined;
    code!: string | undefined;
    category!: string | undefined;
    ...
    system!: string | undefined;
    series!: string | undefined;
    materials!: ProductInventoryMaterialCreateDto[] | undefined;

    constructor(data?: IProductInventoryModuleCreateDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["materials"])) {
                ...
                for (let item of _data["materials"])
                    this.materials!.push(ProductInventoryMaterialCreateDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ProductInventoryModuleCreateDto {
        data = typeof data === 'object' ? data : {};
        let result = new ProductInventoryModuleCreateDto();
        result.init(data);
        return result;
    }
...
export interface IProductInventoryModuleCreateDto {
    level: string | undefined;
    name: string | undefined;
    code: string | undefined;
    category: string | undefined;
...
export class ProductInventoryModuleDto implements IProductInventoryModuleDto {
    id!: string;
    creationTime!: dayjs.Dayjs;
    creatorId!: string | undefined;
    lastModificationTime!: dayjs.Dayjs | undefined;
    ...
    system!: string | undefined;
    series!: string | undefined;
    materials!: ProductInventoryMaterialDto[] | undefined;

    constructor(data?: IProductInventoryModuleDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["materials"])) {
                this.materials = [] as any;
                for (let item of _data["materials"])
                    this.materials!.push(ProductInventoryMaterialDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ProductInventoryModuleDto {
        data = typeof data === 'object' ? data : {};
        let result = new ProductInventoryModuleDto();
        result.init(data);
        return result;
    }
...
export interface IProductInventoryModuleDto {
    id: string;
    creationTime: dayjs.Dayjs;
    creatorId: string | undefined;
    lastModificationTime: dayjs.Dayjs | undefined;
...
export class ProductInventoryProductCreateDto implements IProductInventoryProductCreateDto {
    name!: string | undefined;
    code!: string | undefined;
    category!: string | undefined;
    version!: string | undefined;
    ...
    projectCode!: string | undefined;
    projectName!: string | undefined;
    modules!: ProductInventoryModuleCreateDto[] | undefined;
    materials!: ProductInventoryMaterialCreateDto[] | undefined;

    constructor(data?: IProductInventoryProductCreateDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["modules"])) {
                ...
                for (let item of _data["modules"])
                    this.modules!.push(ProductInventoryModuleCreateDto.fromJS(item));
            }
            if (Array.isArray(_data["materials"])) {
                this.materials = [] as any;
                for (let item of _data["materials"])
    ...
    static fromJS(data: any): ProductInventoryProductCreateDto {
        data = typeof data === 'object' ? data : {};
        let result = new ProductInventoryProductCreateDto();
        result.init(data);
        return result;
    }
...
export interface IProductInventoryProductCreateDto {
    name: string | undefined;
    code: string | undefined;
    category: string | undefined;
    version: string | undefined;
...
export class ProductInventoryProductDto implements IProductInventoryProductDto {
    id!: string;
    creationTime!: dayjs.Dayjs;
    creatorId!: string | undefined;
    lastModificationTime!: dayjs.Dayjs | undefined;
    ...
    modules!: ProductInventoryModuleDto[] | undefined;
    materials!: ProductInventoryMaterialDto[] | undefined;

    constructor(data?: IProductInventoryProductDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.remark = _data["remark"];
            this.createUser = _data["createUser"];
            this.modifiyUser = _data["modifiyUser"];
            this.system = _data["system"];
            this.series = _data["series"];
            this.projectCode = _data["projectCode"];
            this.projectName = _data["projectName"];
            ...
            if (Array.isArray(_data["modules"])) {
                this.modules = [] as any;
                for (let item of _data["modules"])
                    this.modules!.push(ProductInventoryModuleDto.fromJS(item));
            }
            if (Array.isArray(_data["materials"])) {
                this.materials = [] as any;
                for (let item of _data["materials"])
    ...
    static fromJS(data: any): ProductInventoryProductDto {
        data = typeof data === 'object' ? data : {};
        let result = new ProductInventoryProductDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["remark"] = this.remark;
        data["createUser"] = this.createUser;
        data["modifiyUser"] = this.modifiyUser;
        data["system"] = this.system;
        data["series"] = this.series;
        data["projectCode"] = this.projectCode;
        data["projectName"] = this.projectName;
...
export interface IProductInventoryProductDto {
    id: string;
    creationTime: dayjs.Dayjs;
    creatorId: string | undefined;
    lastModificationTime: dayjs.Dayjs | undefined;
...
export class ProductInventoryProductDtoPagedResultDto implements IProductInventoryProductDtoPagedResultDto {
    items!: ProductInventoryProductDto[] | undefined;
    totalCount!: number;

    constructor(data?: IProductInventoryProductDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items!.push(ProductInventoryProductDto.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): ProductInventoryProductDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new ProductInventoryProductDtoPagedResultDto();
        result.init(data);
        return result;
    }
...
export interface IProductInventoryProductDtoPagedResultDto {
    items: ProductInventoryProductDto[] | undefined;
    totalCount: number;
}

export enum ProductInventoryPublishStatus {
    InMark = 0,
    DelayInMark = 1000,
    OutMark = 10000,
    DelayOutMark = 100000,
...
export class ProductInventoryTreeDto implements IProductInventoryTreeDto {
    id!: string;
    parentId!: string | undefined;
    parent!: ProductInventoryTreeDto;
    name!: string | undefined;
    children!: ProductInventoryTreeDto[] | undefined;
    remark!: string | undefined;

    constructor(data?: IProductInventoryTreeDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.id = _data["id"];
            this.parentId = _data["parentId"];
            this.parent = _data["parent"] ? ProductInventoryTreeDto.fromJS(_data["parent"]) : <any>undefined;
            this.name = _data["name"];
            if (Array.isArray(_data["children"])) {
                this.children = [] as any;
                for (let item of _data["children"])
                    this.children!.push(ProductInventoryTreeDto.fromJS(item));
            }
            this.remark = _data["remark"];
        }
    }

    static fromJS(data: any): ProductInventoryTreeDto {
        data = typeof data === 'object' ? data : {};
        let result = new ProductInventoryTreeDto();
        result.init(data);
        return result;
    }
...
export interface IProductInventoryTreeDto {
    id: string;
    parentId: string | undefined;
    parent: ProductInventoryTreeDto;
    name: string | undefined;
...
export enum ProductInventroyTag {
    Undefined = 0,
    Product = 1,
    Modules = 2,
    Material = 4,
...
export class ProductRetrievalDto implements IProductRetrievalDto {
    id!: string;
    name!: string | undefined;
    code!: string | undefined;
    tag!: ProductInventroyTag;

    constructor(data?: IProductRetrievalDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ProductRetrievalDto {
        data = typeof data === 'object' ? data : {};
        let result = new ProductRetrievalDto();
        result.init(data);
        return result;
    }
...
export interface IProductRetrievalDto {
    id: string;
    name: string | undefined;
    code: string | undefined;
    tag: ProductInventroyTag;
...
export class ProductRetrievalDtoPagedResultDto implements IProductRetrievalDtoPagedResultDto {
    items!: ProductRetrievalDto[] | undefined;
    totalCount!: number;

    constructor(data?: IProductRetrievalDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items!.push(ProductRetrievalDto.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): ProductRetrievalDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new ProductRetrievalDtoPagedResultDto();
        result.init(data);
        return result;
    }
...
export interface IProductRetrievalDtoPagedResultDto {
    items: ProductRetrievalDto[] | undefined;
    totalCount: number;
}
...
export class ProductRetrievalResultDto implements IProductRetrievalResultDto {
    ...
    constructor(data?: IProductRetrievalResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ProductRetrievalResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new ProductRetrievalResultDto();
        result.init(data);
        return result;
    }
...
export class ProductRetrievalResultDtoPagedResultDto implements IProductRetrievalResultDtoPagedResultDto {
    items!: ProductRetrievalResultDto[] | undefined;
    totalCount!: number;

    constructor(data?: IProductRetrievalResultDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items!.push(ProductRetrievalResultDto.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): ProductRetrievalResultDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new ProductRetrievalResultDtoPagedResultDto();
        result.init(data);
        return result;
    }
...
export interface IProductRetrievalResultDtoPagedResultDto {
    items: ProductRetrievalResultDto[] | undefined;
    totalCount: number;
}

export class ProductRetrievalSearchDto implements IProductRetrievalSearchDto {
    maxResultCount!: number;
    skipCount!: number;
    sorting!: string | undefined;
    ...
    static fromJS(data: any): ProductRetrievalSearchDto {
        data = typeof data === 'object' ? data : {};
        let result = new ProductRetrievalSearchDto();
        result.init(data);
        return result;
    }
...
export interface IProductRetrievalSearchDto {
    maxResultCount: number;
    skipCount: number;
    sorting: string | undefined;
    searchInfo: { [key: string]: ProductInventroyTag; } | undefined;
...
export class ProjectInfoDto implements IProjectInfoDto {
    ...
    static fromJS(data: any): ProjectInfoDto {
        data = typeof data === 'object' ? data : {};
        let result = new ProjectInfoDto();
        result.init(data);
        return result;
    }
...
export class StandardAndPolicyCreateAndUpdateDto implements IStandardAndPolicyCreateAndUpdateDto {
    ...
    constructor(data?: IStandardAndPolicyCreateAndUpdateDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.data = _data["data"] ? StandardAndPolicyLibDto.fromJS(_data["data"]) : <any>undefined;
    ...
    static fromJS(data: any): StandardAndPolicyCreateAndUpdateDto {
        data = typeof data === 'object' ? data : {};
        let result = new StandardAndPolicyCreateAndUpdateDto();
        result.init(data);
        return result;
    }
...
export interface IStandardAndPolicyCreateAndUpdateDto {
    data: StandardAndPolicyLibDto;
    themes: string[] | undefined;
}
...
export class StandardAndPolicyLibDto implements IStandardAndPolicyLibDto {
    ...
    /** 发布单位 */
    publishingUnit!: string | undefined;
    /** 发布日期 */
    publishingDate!: dayjs.Dayjs;
    /** 实施日期 */
    implementationDate!: dayjs.Dayjs;
    /** 图片地址 */
    imagePath!: string | undefined;
    /** PDF地址 */
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.publishingUnit = _data["publishingUnit"];
            this.publishingDate = _data["publishingDate"] ? dayjs(_data["publishingDate"].toString()) : <any>undefined;
            this.implementationDate = _data["implementationDate"] ? dayjs(_data["implementationDate"].toString()) : <any>undefined;
            this.imagePath = _data["imagePath"];
    ...
    static fromJS(data: any): StandardAndPolicyLibDto {
        data = typeof data === 'object' ? data : {};
        let result = new StandardAndPolicyLibDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["publishingUnit"] = this.publishingUnit;
        data["publishingDate"] = this.publishingDate ? this.publishingDate.toLocaleString() : <any>undefined;
        data["implementationDate"] = this.implementationDate ? this.implementationDate.toLocaleString() : <any>undefined;
        data["imagePath"] = this.imagePath;
...
export class StandardAndPolicyPageDto implements IStandardAndPolicyPageDto {
    ...
    static fromJS(data: any): StandardAndPolicyPageDto {
        data = typeof data === 'object' ? data : {};
        let result = new StandardAndPolicyPageDto();
        result.init(data);
        return result;
    }
...
export class StandardAndPolicySearchDto implements IStandardAndPolicySearchDto {
    ...
    static fromJS(data: any): StandardAndPolicySearchDto {
        data = typeof data === 'object' ? data : {};
        let result = new StandardAndPolicySearchDto();
        result.init(data);
        return result;
    }
...
export interface IStandardAndPolicySearchDto {
    maxResultCount: number;
    skipCount: number;
    sorting: string | undefined;
    /** Id */
...
export class StandardAndPolicyThemeDto implements IStandardAndPolicyThemeDto {
    ...
    treeId!: string;
    tree!: StandardAndPolicyTreeDto;

    constructor(data?: IStandardAndPolicyThemeDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.tree = _data["tree"] ? StandardAndPolicyTreeDto.fromJS(_data["tree"]) : <any>undefined;
        }
    }

    static fromJS(data: any): StandardAndPolicyThemeDto {
        data = typeof data === 'object' ? data : {};
        let result = new StandardAndPolicyThemeDto();
        result.init(data);
        return result;
    }
...
export interface IStandardAndPolicyThemeDto {
    id: string;
    creationTime: dayjs.Dayjs;
    creatorId: string | undefined;
    lastModificationTime: dayjs.Dayjs | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["children"])) {
                this.children = [] as any;
                for (let item of _data["children"])
                    this.children!.push(StandardAndPolicyTreeDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): StandardAndPolicyTreeDto {
        data = typeof data === 'object' ? data : {};
        let result = new StandardAndPolicyTreeDto();
        result.init(data);
        return result;
    }
...
export class StandardAndStandLibWithAllTreeDto implements IStandardAndStandLibWithAllTreeDto {
    lib!: StandardAndPolicyLibDto;
    themes!: string[] | undefined;

    constructor(data?: IStandardAndStandLibWithAllTreeDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): StandardAndStandLibWithAllTreeDto {
        data = typeof data === 'object' ? data : {};
        let result = new StandardAndStandLibWithAllTreeDto();
        result.init(data);
        return result;
    }
